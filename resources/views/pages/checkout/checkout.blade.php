                    ...
                    <form>
                        ...
                        @if ($customer_id)
                            @foreach ($customer_info as $customer_info)
                                ...
                                <div class="floating-label">
                                    <input class="float_input" type="password" name="inputPassword" id="inputName" readonly
                                        value="{{$customer_info->customer_password}}">
                                    <label class="form-label" for="inputName">Mật khẩu</label>
                                </div>
                        ...
                        @else
                            <div class="floating-label">
                                <input class="float_input" type="text" name="inputName" id="inputName" autocomplete="off"
                            ...
                            <div class="floating-label">
                                <input class="float_input" type="password" name="inputPassword" id="inputName" autocomplete="off"
                                    data-validation="required" data-validation="length" data-validation-length="5-200" data-validation-error-msg="Bạn cần nhập mật khẩu"
                                    placeholder="Mật khẩu*" required>
                                <label class="form-label" for="inputName">Mật khẩu*</label>
                            </div>

                            <div class="floating-label">
                                <input class="float_input" type="text" name="inputPhone" id="inputPhone" autocomplete="off"
                            ...
                            <div class="floating-label">
                                <input class="float_input" type="email" name="inputMail" id="inputMail" autocomplete="off"
                            ...
                            <div class="selected floating-label">
                            ...
                            <div class="floating-label">
                                <input class="float_input" type="text" name="inputAddress" id="inputAddress" autocomplete="off"
        ...
        <section class="your-cart">
            <div class="container">
                ...
                <div class="checkout-footer2">
                    ...
                    <a href="{{url('/coming-soon')}}">chính sách riêng tư</a>.
                </div>
